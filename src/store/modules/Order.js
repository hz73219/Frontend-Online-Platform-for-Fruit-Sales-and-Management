    ...
    actions: {
        async fetchListData({ commit }) {
            ...
            if(token!="")
            {
                ...
                axios
                    .get('https://localhost:7202/api/Order/Getall',config)
                    .then(response => {
        ...
        async createObj({ commit }, obj) {
                ...
                if (token!="") {
                    ...
                    var result = await
                            axios
                            .post('https://localhost:7202/api/Order/Create',  obj, config)
                            .then(response => {
        ...
        async updateObj({ commit }, obj) {
            ...
            if (token) {
                ...
                var result = await
                        axios
                        .put('https://localhost:7202/api/Order/Update', obj, config)
                        .then(response => {
        ...
        async updateStatus({ commit }, obj) {
            ...
            if (token) {
                ...
                var result = await
                        axios
                        .put(`https://localhost:7202/api/Order/UpdateStatus?id=${obj.id}&status=${obj.status}`,null, config)
                        .then(response => {
                            commit('UPDATE', response.data);
                            return true;
                        })
        ...
        async deleteObj({ commit }, obj) {
            ...
            if (token) {
                ...
                var resut = await
                        axios
                        .delete('https://localhost:7202/api/Order/Delete?id=' + obj.id, config)
                        .then(response => {
