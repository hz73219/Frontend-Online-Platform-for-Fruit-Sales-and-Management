...
export default {
    ...
    actions: {
        async fetchListData({ commit }) {
            axios
                .get('https://localhost:7202/api/voucher/GetAll')
                .then(response => {
        ...
        async createObj({ commit }, obj) {
            ...
            if (token) {
                ...
                var result = await
                        axios
                        .post('https://localhost:7202/api/voucher/Create', obj, config)
                        .then(response => {
        ...
        async updateObj({ commit }, obj) {
            ...
            if (token) {
                ...
                var result = await
                        axios
                        .put('https://localhost:7202/api/voucher/Update', obj, config)
                        .then(response => {
        ...
        async deleteObj({ commit }, obj) {
            ...
            if (token) {
                ...
                var resut = await
                        axios
                        .delete('https://localhost:7202/api/voucher/Delete?id=' + obj.id, config)
                        .then(response => {
